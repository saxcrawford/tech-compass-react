		...
		<div className="contact-content">
			...
			<form className="contact-form" noValidate onSubmit={handleSubmit}>
				...
				<div className={`form-group ${error.email || error.emailFormat ? "error" : ""}`}>
					...
					<input type="email" id="email" name="email" placeholder="you@example.com" value={formData.email}
					       onChange={handleChange}/>
				...
				<p className={`form-success ${isVisible ? "visible" : ""}`}>Thanks for reaching out! We'll get back to
					you soon.</p>
			</form>
		</div>
	);
